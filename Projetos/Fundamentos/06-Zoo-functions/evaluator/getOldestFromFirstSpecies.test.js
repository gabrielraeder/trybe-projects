...
describe('10 - Crie uma função que busca o animal mais velho da primeira espécie gerenciada', () => {
  it('passado o id de uma pessoa colaboradora, encontra a primeira espécie de animal gerenciado por essa pessoa, e retorna um array com nome, sexo e idade do animal mais velho dessa espécie', () => {
    const expected = [
      ['Maxwell', 'male', 15],
      ['Maxwell', 'male', 15],
